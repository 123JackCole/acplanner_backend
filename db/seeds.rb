...
def seedBugs(bugsArray)
    bugsArray.each_with_index do |element, index|
        begin
            RestClient.get("#{API_ENDPOINT}critter/#{bugsArray[index]}#{ENV["API_KEY"]}"){ |response, request, result, &block|
                case response.code
                when 200
...
def seedFish(fishArray)
    fishArray.each_with_index do |element, index|
        begin
            RestClient.get("#{API_ENDPOINT}critter/#{fishArray[index]}#{ENV["API_KEY"]}"){ |response, request, result, &block|
                case response.code
                when 200
...
def seedFossils(fossilsArray)
    fossilsArray.each_with_index do |element, index|
        begin
            RestClient.get("#{API_ENDPOINT}fossil/#{fossilsArray[index]}#{ENV["API_KEY"]}"){ |response, request, result, &block|
                case response.code
                when 200
...
def seedVillagers(villagersArray)
    villagersArray.each_with_index do |element, index|
        begin
            RestClient.get("#{API_ENDPOINT}villager/#{villagersArray[index]}#{ENV["API_KEY"]}"){ |response, request, result, &block|
                case response.code
                when 200
